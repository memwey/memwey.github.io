...
### 近期动态
学车中, 用大语言模型糊代码开心, 金融支付的业务流程和系统审批太繁琐, 不能愉快的写代码
...
### Recent Updates
Learning to drive, happily tinkering with code using large language models; the business processes and approval procedures in financial payments are so cumbersome that writing code is no longer much fun.
...
### 最近の動向
運転を習っています。大規模言語モデルでコードを書いて楽しんでいますが、金融決済の業務フローとシステムの承認プロセスが煩雑すぎて、気持ちよくコードを書けません。
